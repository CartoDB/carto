    ...
    "symbolizers" : {
        ...
        "shield": {
            ...
            "repeat-distance": {
                ...
                "doc": "Minimum distance between repeated shields. If set this will prevent shields being rendered nearby each other that contain the same text. Similiar to shield-min-distance with the difference that it works the same no matter what placement strategy is used."
            },
            "minimum-distance": {
            ...
            "minimum-padding": {
                ...
                "expression":true,
                "default-value": 0,
                "doc": "Minimum distance a shield will be placed from the edge of a tile. This option is similiar to shield-avoid-edges:true except that the extra margin is used to discard cases where the shield+margin are not fully inside the tile.",
        ...
        "text": {
            ...
            "repeat-distance": {
                ...
                "doc": "Minimum distance between repeated text. If set this will prevent text labels being rendered nearby each other that contain the same text. Similiar to text-min-distance with the difference that it works the same no matter what placement strategy is used."
            },
            "minimum-distance": {
            ...
            "minimum-padding": {
                ...
                "type": "float",
                "expression":true,
                "doc": "Minimum distance a text label will be placed from the edge of a tile. This option is similiar to shield-avoid-edges:true except that the extra margin is used to discard cases where the shield+margin are not fully inside the tile.",
            ...
            "placement": {
                ...
                "expression":true,
                "default-meaning": "One shield will be placed per geometry.",
                "doc": "How this label should be placed. Point placement places one label on top of a point geometry and at the centriod of a polygon or the middle point of a line, line places along lines multiple times per feature, vertex places on the vertexes of polygons, and interior attempts to place inside of a polygon."
            },
            "placement-type": {
